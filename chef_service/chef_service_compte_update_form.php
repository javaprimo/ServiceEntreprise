...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title">Bienvenue Mme/Mr <?php echo strtoupper($dataEmp['NOM']) . " " . $dataEmp['PRENOM'] ?> sur la page de mise à jour de vos données</h3>
	</div>
	<div class="panel-body">
		<form method="POST" action="index.php?page=chef_service/chef_service_compte_update">
			<div class="form-row">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<a type="submit" href="index.php?page=accueil&success=2" class="btn btn-success stretched-link">Annuler</a>
				</div>
			</div>
		</form>
	</div>
